  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-black px-4">
      ...
      >
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4 text-center">Заказ успешно доставлен!</h1>
        <p className="text-white/70 text-lg mb-8 text-center max-w-md">
          Спасибо за заказ. Приятного аппетита! Историю заказов можно посмотреть в профиле.
        </p>
